  ...
  render() {
    ...
    <Slide transition={["slide"]}>
      <Heading size={4} textColor="tertiary">Stateless Component</Heading>
    	<p>
      	<S type="italic" textColor="tertiary">Also know as a "Dumb" Component.</S>
	    </p>
    	<List>
    	  <Appear>
    ...
    <Slide transition={["slide"]}>
      ...
      <Appear>
		    <List>
	      	...
	      	<ListItem textColor="tertiary"><Link href="https://maticrivo.github.io/talks/react-intro" target="_blank">This presentation</Link> - <Link href="https://github.com/maticrivo/talks/tree/master/react-intro" target="_blank">source code</Link></ListItem>
